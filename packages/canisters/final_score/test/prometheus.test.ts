...
import { idlFactory as mcpServerIdlFactory } from '../../../../.dfx/local/canisters/final_score/service.did.js';
import type { _SERVICE as McpServerService } from '../../../../.dfx/local/canisters/final_score/service.did.d.ts';
...
const MCP_SERVER_WASM_PATH = path.resolve(
  __dirname,
  '../../../../.dfx/local/canisters/final_score/final_score.wasm',
);
...
describe('MCP Server Requirements', () => {
  ...
  beforeAll(async () => {
    ...
    testApiKey = await serverActor.create_my_api_key('test-key', []);
  });
